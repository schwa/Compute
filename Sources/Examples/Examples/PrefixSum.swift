...
enum PrefixSum: Demo {
    ...
    static func main() async throws {
        ...
        let values: [UInt32] = (0..<(2 ** 16)).map { _ in UInt32.random(in: 0..<1024)}
        print(values.count)
...
//        let values: [UInt32] = [3, 1, 7, 0, 4, 1, 6, 3] // [0, 3, 4, 11, 11, 15, 16, 22]
    ...
    static let source = #"""
        ...
        void reduce(
            ...
            auto n = count;
            auto k = thread_position_in_grid;
            auto s = threads_per_grid;

            auto index1 = (k * n / s - 1 + (k + 1) * n / s - 1) / 2;
            auto index2 = (k + 1) * n / s - 1;
